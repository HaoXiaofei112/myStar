...
//    为你推荐
    ...
    // // //内容二
    // $('.l22').click(function(){//上一张
    //     numss2 = numss2 - 1;
    //         if(numss2<0){numss2=3}
    //     displayLir();})
    // $('.r22').click(function(){//下一张
    //     numss2 = numss2 + 1;
    //     if(numss2>3){numss2=0}
    //     displayLir();})
    // function displayLir(){
    //     $('.contBox2 li').eq(numss2).removeClass('hide').siblings('li').addClass('hide');
    //     $('.round2-t p').eq(numss2).css({'background':'none','border':'2px solid orange'}).siblings('p').css({'background':"#ccc", 'border':'2px solid #fff'});}
    // $('.round2-t p').click(function () {
    //     numss2 = $(this).index()
    //     $('.contBox2 li').eq(numss2).removeClass('hide').siblings('li').addClass('hide');
    //     $(this).css({'background':'none','border':'2px solid orange'}).siblings('p').css({'background':"#ccc", 'border':'2px solid #fff'});})
    // //内容三
    // $('.l23').click(function(){//上一张
    //     numss2 = numss2 - 1;
    //        if(numss2<0){numss2=3}
    //     displayLis();})
    // $('.r23').click(function(){//下一张
    //     numss2 = numss2 + 1;
    //     if(numss2>3){numss2=0}
    //     displayLis();})
    // function displayLis(){
    //     $('.contBox3 li').eq(numss2).removeClass('hide').siblings('li').addClass('hide');
    //     $('.round2-s p').eq(numss2).css({'background':'none','border':'2px solid orange'}).siblings('p').css({'background':"#ccc", 'border':'2px solid #fff'});}
    // $('.round2-s p').click(function () {
    //      numss2 = $(this).index()
    //     $('.contBox3 li').eq(numss2).removeClass('hide').siblings('li').addClass('hide');
    //     $(this).css({'background':'none','border':'2px solid orange'}).siblings('p').css({'background':"#ccc", 'border':'2px solid #fff'});})
    // //内容4
    // $('.l24').click(function(){//上一张
    //     numss2 = numss2 - 1;
    //        if(numss2<0){numss2=3}
    //     displayLi();})
    // $('.r24').click(function(){//下一张
    //     numss2 = numss2 + 1;
    //    if(numss2>3){numss2=0}
    //     displayLi();})
    // function displayLi(){
    //     $('.contBox4 li').eq(numss2).removeClass('hide').siblings('li').addClass('hide');
    //          $('.round2-f p').eq(numss2).css({'background':'none','border':'2px solid orange'}).siblings('p').css({'background':"#ccc", 'border':'2px solid #fff'});}
    // $('.round2-f p').click(function () {
    //      numss2 = $(this).index()
    //     $('.contBox4 li').eq(numss2).removeClass('hide').siblings('li').addClass('hide');
    //      $(this).css({'background':'none','border':'2px solid orange'}).siblings('p').css({'background':"#ccc", 'border':'2px solid #fff'});})
    //左右button隐藏显示
